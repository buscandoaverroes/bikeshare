...
This is corroborated by a bivariate regression, which shows that the percent of rides in 2020 going to a "near-metro" bikeshare station is about 6% lower (p<0.001), on average compared to 2018, for all departing bikeshare stations.
...
In 2018 and 2019, there were considerably more than 3 million rides over the course of each year, or over 8,000 rides per day, on average.

However, even through September, 2020, the number of total rides in 2020 is notably lower than the counts of the previous two years. 
...
When breaking out by month, we see that the biggest differences between 2020 and pre-pandemic years occur in the early months of the pandemic: April and May. 
