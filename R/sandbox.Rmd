...
Visualizing the median ride duration across geography, on average, for 2017 through 2020.

```{r}
pal <- colorQuantile("PuOr", sum_station$dur_med, 5)
