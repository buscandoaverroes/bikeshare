...
bks1721 <- readRDS(file.path(processed, "data/years/bks_2017-21.Rda"))
nrow_bks1721 <- nrow(bks1721)
...
bks1721$dur0 <- bks1721$dur
bks1721$dur0[bks1721$dur0 < 0] <- NA 
