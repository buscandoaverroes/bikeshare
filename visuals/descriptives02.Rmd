...
**Median Ride Duration**: A measure of how long the 'average' ride lasted, in seconds. Mathematically, the median is used in lieu of average to avoid upward-skewing from extremely long rides (such as those that forgot to properly dock the bike).
